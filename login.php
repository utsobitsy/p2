...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <div class="text">
          <span class="text-1">Gimnasio Obregón<br></span>
          <span class="text-2">Sistema Escolar</span>
        </div>
      </div>
    ...
    <div class="forms">
      <div class="form-content">
        <div class="login-form">
          ...
          <div class="title" id='board-title'>Iniciar Sesión</div>
          ...
          <form action="index.php" id="login-form" method="post">
            <div class="input-boxes">
              <div class="input-box">
                ...
                <input type="email" name="email" placeholder="Ingresa tu correo" id='loginEmail' required>
              </div>
              <div class="input-box">
              ...
              <div class="text"><a id="forgotpassword">Olvidaste la contraseña?</a></div>
